    ...
    with open(input_file, mode="r", newline="", encoding="utf-8") as infile:
        ...
        with open(output_file, mode="w", newline="", encoding="utf-8") as outfile:
            ...
            for row in rows[1:]:  # Skip the first row (the question)
                ...
                # Write essay and its scores to the output file
                writer.writerow(
                    [essay, phase_1_score, phase_2_score, plagiarism_score, ai_score]
                )


# Example usage
input_file = "essays.csv"  # Replace with your input CSV file path
output_file = "scored_essays.csv"  # Replace with your desired output CSV file path
